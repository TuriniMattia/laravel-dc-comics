...
// $data = $this->getCSVData(__DIR__ . '/comics.csv');

// foreach ($data as $index => $row) {

//     if ($index !== 0) {
//         $new_item = new Comic();
//         $new_item->title = $row[0];
//         $new_item->description = $row[1];
//         $new_item->thumb = $row[2];
//         $new_item->price = $row[3];
//         $new_item->series = $row[4];
//         $new_item->sale_date = $row[5];
//         $new_item->type = $row[6];
//         $new_item->artist = $row[7];
//         $new_item->writers = $row[8];
//         $new_item->save();
//     }
// }